<?php
    ...
    $packageName = $packageController->getPackageNames();
...
<body>
    ...
    <div class="row">
     <div class="col-sm-6">
        ...
        <div class="card-body text">
            <h3 class="card-title" style="text-align: center;">Payment By Year</h3>
            <div class="clearfix">&nbsp;</div>
            <div class="row mb-3">
            <div class="col-sm-6">
            <label style="font-weight:bold; text-align:center;"> year </label>
        ...
        <button class="btn btn-primary"   onclick="paymentCount()">View Report</button>
    ...
    <script>
       function paymentCount(){
            ...
            window.open(`reportpdf.php?type=payment_analysis&year=${Year}`, '_blank');
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            $.post('../ajax/paymentajax.php', {
                action: 'getLastYearMonthlyIncome'
            }, function(response){
