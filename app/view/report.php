         ...
         <div class="row">
            <div class="col-sm-3">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="reportreservation.php" class="btn btn-outline-info">Reservation Reports</a>
                </div>
                </div>
            </div>
            <div class="col-sm-3">
            ...
            <div class="col-sm-3">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="reportpayment.php" class="btn btn-outline-info">Payment Reports</a>
                </div>
                </div>
            </div>
            <div class="col-sm-3">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="reportfeedback.php" class="btn btn-outline-info">Feedback Reports</a>
                </div>
                </div>
            </div>
            <div class="col-sm-3">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="reportcustomer.php" class="btn btn-outline-info">Customer Reports</a>
                </div>
                </div>
            </div>
            <div class="col-sm-3">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="reportfood.php" class="btn btn-outline-info">Food Reports</a>
                </div>
                </div>
            </div>
