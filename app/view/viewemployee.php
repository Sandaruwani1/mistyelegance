                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-left">
                                    ...
                                    <li class="active">
                                        <?php echo $employeeData['emp_fname'] . " " . $employeeData['emp_lname']; ?>
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <img width="100%" class="rounded mx-auto d-block"
                            src="../resources/images/users/<?php echo $employeeData['emp_image']; ?>" />
                    </div>
                    <div class="col-lg-8">
                        <div class="card">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" id="updateEmployeeForm">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input"
                                                    class=" form-control-label">First Name </label></div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="emp-fname" name="emp-fname"
                                                    placeholder="Enter your first Name" class="form-control"
                                                    value="<?php echo $employeeData['emp_fname']; ?>" required>
                                                <span class="text text-danger small" id="emp-fname-error"></span>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input"
                                                    class=" form-control-label"> Surname </label></div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="emp-lname" name="emp-lname"
                                                    placeholder="Employee Surame" class="form-control"
                                                    value="<?php echo $employeeData['emp_lname']; ?>" required>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="email" id="emp-email" name="emp-email"
                                                    placeholder="Employee Email" class="form-control"
                                                    value="<?php echo $employeeData['emp_email']; ?>" readonly>
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input"
                                                    class=" form-control-label">NIC Number </label></div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="emp-nic" name="emp-nic"
                                                    placeholder="Employee NIC" class="form-control"
                                                    value="<?php echo $employeeData['emp_nic']; ?>" readonly>
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="textarea-input"
                                                    class=" form-control-label">Address </label></div>
                                            <div class="col-12 col-md-9"><textarea id="emp-address" name="emp-address"
                                                    rows="2" placeholder="address" class="form-control"
                                                    required><?php echo $employeeData['emp_address']; ?>"</textarea>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input"
                                                    class=" form-control-label">Date Of Birth </label></div>
                                            <div class="col-12 col-md-9"><input type="date" id="emp-dob" name="emp-dob"
                                                    placeholder="Employee Date Of Birth" class="form-control"
                                                    max="<?php echo date('Y-m-d', strtotime('-18 year')) ?>"
                                                    value="<?php echo $employeeData['emp_dob']; ?>" required></div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input"
                                                    class=" form-control-label">Contact number </label></div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="emp-tel" name="emp-tel"
                                                    placeholder="Employee Phone number" class="form-control"
                                                    value="<?php echo $employeeData['emp_tel']; ?>" required>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            ?>
                                                    <option value="<?php echo $designation['desig_id']; ?>"
                                                        <?php echo ($designation['desig_id'] == $employeeData['desig_id'])?'selected':'' ?>>
                                                        <?php echo $designation['desig_Title']; ?></option>
                                                    <?php
                                                }
                                            ?>
                                            ...
                                            <div class="col col-md-9">
                                                <div class="form-check-inline form-check">
                                                    ...
                                                    <label for="inline-radio1" class="form-check-label ">
                                                        <input type="radio" id="emp-genderf" name="emp-gender"
                                                            value="Female" class="form-check-input"
                                                            <?php echo ($employeeData['emp_gender'] == 'Female')?'checked':'' ?>>Female
                                                    </label>

                                                    <label for="inline-radio2" class="form-check-label ">
                                                        <input type="radio" id="emp-genderm" name="emp-gender"
                                                            value="Male" class="form-check-input"
                                                            <?php echo ($employeeData['emp_gender'] == 'Male')?'checked': '' ?>>Male
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="file-input"
                                                    class=" form-control-label">Employee Image </label></div>
                                            <div class="col-12 col-md-9"><input type="file" id="emp-image"
                                                    name="file-input" class="form-control-file" accept="image/*"></div>
                                        </div>
                                        <div class="modal-footer">

                                            <input type="hidden" name="emp-id"
                                                value="<?php echo $employeeData['emp_id']; ?>" />
    ...
    $("#updateEmployeeForm").submit(function(event) {
        ...
        if (designationId == 0) {
            ...
            return false;
                ...
                $("#updateEmployeeForm").unbind('submit').submit();
            }
    });
