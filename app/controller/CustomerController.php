...
class CustomerController{
	...
	function searchCustomer($cus_nic){
		...
		if($result){
			...
			$output .= "<button type='button'>No record</button>";
		}
	...
	function getCustomerRegistrationcount($from,$until){
        return $this->customerModel->getCustomerRegistrationcount($this->con, $from, $until);
    }
