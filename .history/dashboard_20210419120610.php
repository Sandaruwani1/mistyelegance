                    ...
                    <div class="card-body">
                        ...
                        <div style="overflow-x:auto;">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <td><?php echo $onGoingData['arrival_date']; ?></td>
                                    <td><?php echo $onGoingData['leaving_date']; ?></td>
                                    <td><?php echo $onGoingData['room_no']; ?></td>
                                    <td><?php echo $onGoingData['pkg_name']; ?></td>
                                    <td><?php echo $onGoingData['payment_amount']; ?></td>
                                    <td><?php echo $onGoingData['discount']; ?></td>
