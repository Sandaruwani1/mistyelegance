            ...
            <section class="tm-banner">
                <div class="tm-container-outer tm-banner-bg">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <h5 class="card-title">Package: <?php echo $PkgData['pkg_name']; ?></h5>
                            </div>
                            <div class="col-sm-6">
                                <h5 class="card-title">Customer Name: <?php echo $CusData['cus_fname'] . " " . $CusData['cus_lname']; ?></h5>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <h5 class="card-title">Arrival Date: <?php echo $_GET['arr']; ?></h5>
                            </div>
                            <div class="col-sm-6">
                                <h5 class="card-title">Leaving Date: <?php echo $_GET['lev']; ?></h5>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <h5 class="card-title">Adults: <?php echo $_GET['adults']; ?></h5>
                            </div>
                            <div class="col-sm-6">
                                <h5 class="card-title">Children: <?php echo $_GET['children']; ?> </h5>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">

                                <h5 class="card-title">Amount:<?php
                            ...
                            <div class="col-sm-6">
                                <h5 class="card-title">Advance Payment: $<?php echo round($advancePayment); ?> </h5>
                            </div>
