...
if (!isset($_GET['check-in']) || !isset($_GET['check-out']) || !isset($_GET['adult']) || !isset($_GET['children'])) {
   ...
   $AllpkgData=$packagesController->getAllPackages();
    ...
    $packagesController = new PackagesController();
    $AllpkgData = $packagesController->getAvailablePkgs($_GET['check-in'], $_GET['check-out'], $_GET['adult'], $_GET['children']);
}
...
<body>
                            ...
                            <form action="" method="get" class="tm-search-form tm-section-pad-2">
                                <div class="form-row tm-search-form-row">
                                    <div class="form-group tm-form-group tm-form-group-pad tm-form-group-3">
                                        ...
                                        <input name="check-in" id="check-in" type="date" class="form-control"
                                    ...
                                    <div class="form-group tm-form-group tm-form-group-pad tm-form-group-3">
                                        ...
                                        <input name="check-out" id="check-out" type="date" class="form-control"
                                    ...
                                    <div class="form-group tm-form-group tm-form-group-1">
                                        <div class="form-group tm-form-group tm-form-group-pad tm-form-group-3">
                                            ...
                                            <select name="adult" class="form-control tm-select" id="inputAdult"
                                                value="<?php echo (isset($_GET['adults']))?$_GET['adults']: 1;  ?>">
                    ...
                    <div class="tab-pane fade show active" id="4a">
                        ...
                        <div class="tm-recommended-place-wrap">
                            ...
                            if(count($AllpkgData) > 0){
                                $packagesController = new PackagesController();
                            foreach($AllpkgData as $pkgData){
                                $rating = $packagesController->getOverallRatingOfPkg($pkgData['pkg_id']);
                                ?>

                            <div class="tm-recommended-place">
                                <?php
                            $imagePath = "./resources/images/packages/default.png";
                            if(file_exists("./resources/images/packages/" . $pkgData['pkg_id'])) {
                                $images = scandir("./resources/images/packages/" .$pkgData['pkg_id']);
                                
                                if (count($images) > 2) {
                                    $imagePath = "./resources/images/packages/" . $pkgData['pkg_id'] . "/" .$images[2];
                                }
                            }
                            ?>
                                <img src="<?php echo $imagePath; ?>" alt="Image" class="img-fluid tm-recommended-img">
                                <div class="tm-recommended-description-box">
                                    <h3 class="tm-recommended-title"> <?php  echo $pkgData['pkg_name'];?></h3>
                                    <p class="tm-text-highlight">Adults: <?php
                                                                        
                                                                            echo $pkgData['no_of_adults'];
                                                                        
                                                                    ?> | Children: <?php
                                                                    
                                                                        echo $pkgData['no_of_children'];
                                                                    
                                                                ?> | Package Type: <?php
                                                               
                                                                    echo $pkgData['pkg_cat'];
                                                                
                                                            ?>|Room size: <?php echo $pkgData['size_of_rooms'];?> m
                                        <sup>2</sup></p>
                                    <p class="tm-text-gray"> <?php echo $pkgData['pkg_des'];?> </p>
                                    <button type="button" onclick="loadPkgData(<?php echo $pkgData['pkg_id'];?>)"
                                        class="btn btn-primary" data-toggle="modal" data-target="#pkgModal">
                                        View
                                    </button>
                                </div>
                                <a href="javascript:void(0)" onclick="bookNow(<?php echo $pkgData['pkg_id'];?>)"
                                    class="tm-recommended-price-box">
                                    <p class="tm-recommended-price">
                                        <?php
                                    $rate =$pkgData['rate_per_night'];
                                    if (($pkgData['discount_from'] <= date('Y-m-d') && $pkgData['discount_until'] >= date('Y-m-d'))) {

                                            echo  " <del style=''>  $$rate </del>"  . "    " . "$" .  $pkgData['discount'];
                                ...
                                <div class="stars-outer">
                                    <div class="stars-inner" style="width: <?php echo (((int)$AllpkgData['rating']) * 20); ?>%;"></div>
                                </div>
    ...
    <!-- Packages view modal -->
    <div class="modal fade" id="pkgModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="container-fluid">
                        ...
                        <section class="tm-slideshow-section">
                            ...
                            <div class="tm-slideshow-description tm-bg-primary">
                                ...
                                <p style="float:left">Package Category : </p>
                                <p id="pkg_type"></p>
                                <p style="float:left">Bed Type : </p>
                                <p id="bed_type"></p>
                                <p style="float:left">No Of Adults : </p>
                                <p id="no_of_adults"></p>
                                <p style="float:left">No Of Children : </p>
                                <p id="no_of_children"></p>
                                <p style="float:left">No Of Beds : </p>
                                <p id="no_of_bed"></p>
                                <p style="float:left">Package Description : </p>
                                <p id="pkg_des"></p>
                                <p style="float:left">Package Services: </p>
                                <p id="services"></p>
                                <p style="float:left">Size Of the Room : </p>
                                <p id="size_of_rooms"></p>
                                </br>
                                </br>
    ...
    function bookNow(pkgId) {
        ...
        window.location =
            `login.php?pkg_id=${pkgId}&arr_date=${arrDate}&lev_date=${levDate}&adults=${adults}&children=${children}`;
    }
    </script>
