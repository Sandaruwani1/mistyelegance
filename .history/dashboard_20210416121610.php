        ...
        <section class="tm-slideshow-section">
                 ...
                 <div class="tm-slideshow-description tm-bg-primary ">
                    <div class="form-group">
                         <h3 for="name" class=" form-control-label" style="float: left;">First Name : </h3>
                         
                        <span><h4 ><?php echo $customerInfo['cus_fname']; ?></h4> <button type="button" id="username-edit-btn" class="btn btn-link" style="float: right;">[Edit]</button>
                        </span>
                    ...
                    <div class="form-group">
                                        ...
                                        <br/>
                                        <span class="text text-secondary"><?php echo $customerInfo['cus_fname']; ?></span>
                                    </div>

                    <div class="form-group">
                         <label for="name" class=" form-control-label">Last Name</label>
                         <br/>
                        <span><h4><?php echo  $customerInfo['cus_lname']; ?></h4>
                        <button type="submit" class="btn btn-primary btn-sm tm-btn tm-btn-search-sm text-uppercase" id="btnSubmit" style="font-size='10px';" >edit</button>
                        </span>
                    </div>
                    <div class="form-group">
                         <label for="name" class=" form-control-label">Email</label>
                         <br/>
                        <span><?php echo  $customerInfo['cus_email']; ?></span>
                    </div>
                    <div class="form-group">
                         <label for="name" class=" form-control-label">Contact Number</label>
                         <br/>
                        <span><?php echo  $customerInfo['cus_tel']; ?></span>
                    </div>
                    <div class="form-group">
                         <label for="name" class=" form-control-label">NIC</label>
                         <br/>
                        <span><?php echo  $customerInfo['cus_id']; ?></span>
                    </div>
                    <div class="form-group">
                         <label for="name" class=" form-control-label">Country </label>
                         <br/>
                        <span><?php echo  $customerInfo['cus_country']; ?></span>
                    </div>
                    <div class="form-group">
                         <label for="name" class=" form-control-label">Gender</label>
                         <br/>
                        <span><?php echo  $customerInfo['cus_gender']; ?></span>
                    </div>
