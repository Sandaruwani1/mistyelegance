        ...
        <section class="tm-slideshow-section">
                 ...
                 <div class="tm-slideshow-description tm-bg-primary ">
                    <div class="form-group">
                         <label for="name" class=" form-control-label" style="float: left;">First Name : </label>
                         
                        <span><h4 ><?php echo $customerInfo['cus_fname']; ?></h4> <button type="button" id="username-edit-btn" class="btn btn-link" style="float: center;">[Edit]</button>
                        </span>
