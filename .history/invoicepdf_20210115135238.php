...
if ($_GET['type'] == "advance") {
            ...
            <table width=\"90%\" style=\"border: 1px solid black;\" cellpadding=\"5\" cellspacing=\"0\" align =\"center\">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style=\"padding: 25px 5px; border-right: 1px solid black; font-size: 18px;\">" . $PaymentData['pkg_name'] .  "(" . $PaymentData['arrival_date'] . "-" . $PaymentData['leaving_date'] . ") - Advance
                        </td>
    ...
    $foodData = $paymentController->getFoodsByPaymentId($_GET['payment_id']);
    $foodDetailsHtml = "";
    $total = $paymentAmount;

    $pkgPayment = "<tr>
                                
                        <td style=\"padding: 25px 5px; border-right: 1px solid black; font-size: 18px;\">" . $PaymentData['pkg_name'] .  "(" . $PaymentData['arrival_date'] . "-" . $PaymentData['leaving_date'] . ") - Balance
                        </td>
                        <td style=\"padding: 5px; text-align: right; font-size: 20px;\">$" . $paymentAmount . "</td>
                    </tr>";
    foreach($foodData as $food){
        $foodDetailsHtml .= "
        <tr>                     
            <td style=\"padding: 25px 5px; border-right: 1px solid black; font-size: 18px;\">" . $food['food_name'] . "
            </td>
            <td style=\"padding: 5px; text-align: right; font-size: 20px;\">$" . $food['price'] . "</td>
        </tr>
        ";
        $total += $food['price'];
    }
