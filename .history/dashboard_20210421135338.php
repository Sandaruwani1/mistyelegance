            ...
            <div class="tab-content clearfix">
                ...
                <div class="tm-container-outer" id="tm-section-2">
                    ...
                    if (file_exists("./resources/images/customers/" . $customerInfo['cus_id'])) {
                        ...
                        ?>
                            <img src="./resources/images/customers/default.png" alt="Image" width="60%" height="60%"
                                style="border-radius: 50%">
                            <?php
                    } 
                    ?>
                        <button type="button" class="btn btn-primary btn-sm tm-btn tm-btn-search-sm text-uppercase" data-toggle="modal" data-target="#addimage" style="position: relative; left: 30%"> Add Image
                        </div>
