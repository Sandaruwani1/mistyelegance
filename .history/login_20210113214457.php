 ...
 <!-- row -->
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal tm-search-form tm-section-pad-2" id="addCustomerForm">
                                   ...
                                   <div class="row form-group">
                                       ...
                                       <div class="col-12 col-md-9">
                                           <input type="text" id="reg-user-name" name="user-name" placeholder="Enter Your User Name" class="form-control" required>
                                           <span class="text text-danger small" id="user-name-error"></span>
                                       </div>
                                   </div>
                                   ...
                                   <div class="row form-group">
                                       ...
                                       <div class="col-12 col-md-9">
                                           <input type="password" id="regpassword" name="password" placeholder="Enter your Password" class="form-control" required>
    ...
    $("#addCustomerForm").submit(function (event){
            ...
            $.post('./ajax/packagesajax.php',{
                ...
                if(response == 1){
                    $("#username-error").text("User Name exist in the system. Please enter different User Name address");
                    $("#reg-user-name").focus();
                    return false; 
                }else if(response == 2){
                    ...
                    $("#user-name-error").text("User name exist in the system. Please enter different email address");
                    $("#cus-nic").focus();
                    $("#cus-nic-error").text("NIC exist in the system. Please Login");
                    return false; 
                }
                    ...
                    $("#cus-email-error").text("Email address exist in the system. Please enter different email address");
                    $("#cus-email").focus();
                    $("#user-name-error").text("Email address exist in the system. Please enter different email address");
