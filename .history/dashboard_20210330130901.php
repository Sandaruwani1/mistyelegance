        ...
        <section class="tm-slideshow-section">
                 ...
                 <div class="tm-slideshow-description tm-bg-primary ">
                    <div class="form-group">
                         ...
                         <br/>
                        <span><h4><?php echo $customerInfo['cus_fname']; ?></h4></span><button type="submit" class="btn btn-primary btn-sm tm-btn tm-btn-search-sm text-uppercase" id="btnSubmit" style="float: ;">edit</button>
                    </div>
                    <div class="form-group">
