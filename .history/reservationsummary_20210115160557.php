...
-->
            ...
            <section class="tm-banner">
                <div class="tm-container-outer tm-banner-bg">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <h6 class="card-title">Adults: </h6><input type="number" class="form control" placeholder="Adults" value="<?php echo $_GET['adults']; ?>" min="1" max="<?php echo $maxAdultsAndChildrenCountsOfPkg['no_of_adults']; ?>" />
                            </div>
                            <div class="col-sm-6">
                                <h6 class="card-title">Children: </h6><input type="number" class="form control" placeholder="Adults" value="<?php echo $_GET['children']; ?>" min="0" max="<?php echo $maxAdultsAndChildrenCountsOfPkg['no_of_children']; ?>" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
    ...
    <script>
        ...
        $("#confirm-btn").click(function(){
            window.location = "paymentprocess.php"+ "?arr_date=" + $_GET['arr_date'] + "&lev_date=" + $_GET['lev_date'] + "&adults=" + $_GET['adults'] + "&children=" + $_GET['children'] + "&pkg_id=" + $_GET['pkg_id'];
        });
