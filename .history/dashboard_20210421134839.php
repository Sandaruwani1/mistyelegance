        ...
        <div class="tm-container-outer" id="tm-section-3">
            <div class="tab-content clearfix">
                ...
                <div class="tm-container-outer" id="tm-section-2">
                    ...
                    ?>
                        <button type="button" class="btn btn-primary btn-sm tm-btn tm-btn-search-sm text-uppercase" data-toggle="modal" data-target="#addimage" style="float: right;"> Add Image
                        </div>
