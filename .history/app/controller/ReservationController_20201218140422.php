...
class ReservationController{
    ...
    function addReservation ($arrival_date,$leaving_date,$adults,$children,$cus_id,$pkg_id){
      ...
      $amount = checkDiscountandAmount($arrival_date,$leaving_date,$pkg_id);
      $reservationAdded= $this->reservationModel->addReservation($this->con,$arrival_date,$leaving_date,$adults,$children,$cus_id,$pkg_id,$availableRoom['room_id'],$amount);
