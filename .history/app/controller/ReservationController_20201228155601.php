...
class ReservationController{
    ...
    function completeReservation($data){
      if($this->payementModel->addPayment($this->con, $data['balancePrice'],$data['res_id'])){

        if(!$this->reservationModel->completeReservation($this->con, $data['totalPrice'],$data['res_id'])){
