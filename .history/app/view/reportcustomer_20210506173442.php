                ...
                <div class="col-sm-6">
                    <div class="card w-100">
                        <div class="card-body">
                            ...
                            <input type="date" id="report-from-customer-analysis" class="form-control"
                            ...
                            <input type="date" id="report-until-customer-analysis" class="form-control"
                                max="<?php echo date('Y-m-d'); ?>" />
                ...
                <div class="col-sm-6">
                    <div class="card w-100">
                        <div class="card-body text">
                            <h3 class="card-title" style="text-align: center;"> Customer Package reservations For Year
                            </h3>
                            <div class="clearfix">&nbsp;</div>
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input autocomplete="off" type="text" id="cus-nic" name="cus-nic"
                                        placeholder="Customer NIC" class="form-control" required>
                            ...
                            <button class="btn btn-primary" onclick="createCustomerAnalysisReport()">View
                                Report</button>
