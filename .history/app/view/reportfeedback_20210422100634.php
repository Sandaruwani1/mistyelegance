            ...
            <div class="card w-100">
                <div class="card-body">
                    ...
                    <label style="font-weight:bold; text-align:left"> From: </label>
                        ...
                        <input type="date" id="report-from-feedback-analysis" class="form-control"  max="<?php echo date('Y-m-d'); ?>" />
                        <span id="report-from-feedback-analysis-error" class="text text-danger"></span>
                
                        <div class="clearfix">&nbsp;</div>
                        <label style="font-weight: bold;"> Until: </label>
                        
                        <input type="date" id="report-until-feedback-analysis" class="form-control" max="<?php echo date('Y-m-d'); ?>" />
                        <span id="report-until-feedback-analysis-error" class="text text-danger"></span>
                        <div class="clearfix">&nbsp;</div>
                    
                        <button class="btn btn-primary" onclick="createFeedbackAnalysisReport()">View Report</button>
