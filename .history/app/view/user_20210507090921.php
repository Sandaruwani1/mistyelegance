                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        return (row['4'] != <?php echo $loggedUser['user_id'] ?> ) ? (data ==
                            1) ? 
                            "<button class='btn btn-sm btn-outline-secondary' onclick='viewUser(" +data +")'><i class='fa fa-folder-open-o'></i> View</button>  <button class='btn btn-sm btn-outline-danger' onclick='deleteUser(" +
                            data + ")'><i class='fa fa-trash-o'></i> Delete</button>" : "<button class='btn btn-sm btn-outline-secondary' onclick='viewUser(" +
                            data +")'><i class='fa fa-folder-open-o'></i> View</button> <button class='btn btn-sm btn-outline-danger' onclick='deleteUser(" +
                            data + ")'><i class='fa fa-trash-o'></i> Delete</button>" : "<button class='btn btn-sm btn-outline-secondary' onclick='viewUser(" +
                            data +")'><i class='fa fa-folder-open-o'></i> View</button>" ;
                    },
                    "targets": 4,
                    "width": "20%"
                },
