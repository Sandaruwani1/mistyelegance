            ...
            <div class = "card">
                <div class="card-body">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="number" id="food-portion" name="food-portion[]" onblur="getPortionData(this); setTotalAmount();" placeholder="food Portion" value="" class="form-control" required>
