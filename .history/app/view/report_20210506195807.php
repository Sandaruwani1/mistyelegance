         ...
         <div class="row">
            <div class="col-sm-3">
                ...
                <div class="card-body text-center">
                    ...
                    <h5 class="card-title">Reservation Reports</h5>
                    <i class="fa fa-calendar mt-2 mb-2" style="font-size: 60px; display: block;" aria-hidden="true"></i>
                    
                    <a href="reportreservation.php" class="btn btn-outline-primary">Reservation Reports</a>
                </div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="card">
                <div class="card-body text-center">
                    <h5 class="card-title">Package Reports</h5>
                    <i class="fa fa-suitcase mt-2 mb-2" style="font-size:60px; display:block;" aria-hidden="true"></i>

                    <a href="reportpackage.php" class="btn btn-outline-info">Package Reports</a>
                </div>
                </div>
            </div>
            <div class="col-sm-3">
                ...
                <div class="card-body text-center">
                    ...
                    <i class="fa fa-money mt-2 mb-2" style="font-size:60px; display:block;" aria-hidden="true"></i>

                    <a href="reportpayment.php" class="btn btn-primary">Payment Reports</a>
                </div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="card">
                <div class="card-body text-center">
                    <h5 class="card-title">Feedback Reports</h5>
                    <i class="fa fa-comments mt-2 mb-2" style="font-size:60px; display:block;" aria-hidden="true"></i>

                    <a href="reportfeedback.php" class="btn btn-primary">Feedback Reports</a>
                </div>
                </div>
            </div>
            <div class="col-sm-3">
                ...
                <div class="card-body text-center">
                    ...
                    <i class="fa fa-users mt-2 mb-2" style="font-size:60px; display:block;" aria-hidden="true"></i>

                    <a href="reportcustomer.php" class="btn btn-primary">Customer Reports</a>
                </div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="card">
                <div class="card-body text-center">
                    <h5 class="card-title">Food Reports</h5>
                    <i class="fa fa-cutlery mt-2 mb-2" style="font-size:60px; display:block;" aria-hidden="true"></i>

                    <a href="reportfood.php" class="btn btn-primary">Food Reports</a>
                </div>
                </div>
            </div>
