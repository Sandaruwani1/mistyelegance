                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <img width="100%" class="rounded mx-auto d-block"
                            src="../resources/images/users/<?php echo $userData['emp_image']; ?>" />
                    </div>
                    <div class="col-lg-8">
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <br />
                                            <span
                                                class="text text-secondary"><?php echo $userData['emp_fname'] . " " . $userData['emp_lname']; ?></span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br />
                                            <span
                                                class="text text-secondary"><?php echo $userData['emp_email']; ?></span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span id="username-span"
                                                class="text text-secondary"><?php echo $userData['user_name']; ?></span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="button" id="password-edit-btn" class="btn btn-link">[Change
                                                Password]</button>
                                            ...
                                            <div class="form-group" id="password-submit-btn-div">
                                                <button class="btn btn-sm btn-outline-success"
                                                    id="password-submit-btn">Submit</button>
                                                <button class="btn btn-sm btn-outline-danger"
                                                    id="password-cancel-btn"><i class="fa fa-times"></i> Cancel</button>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <input type="submit" id="updateuser" value="Update" class="btn btn-success"
                                                style="display: none;" />
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <br />
                                            <span
                                                class="text text-secondary"><?php echo $userData['desig_Title']; ?></span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br />
                                            <span
                                                class="text text-secondary"><?php echo $userData['emp_address'] ; ?></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="dob" class=" form-control-label">Date of birth</label>
                                            <br />
                                            <span
                                                class="text text-secondary"><?php echo $userData['emp_dob']; ?></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="tel" class=" form-control-label">contact number</label>
                                            <br />
                                            <span
                                                class="text text-secondary"><?php echo $userData['emp_tel']; ?></span>
                                        </div>
