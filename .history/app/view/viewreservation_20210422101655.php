...
<?php
    ...
    if (!isset($_GET['res_id'])) {
        ...
        $reservationData = $reservationController->getReservation($_GET['res_id']);
    }
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-left">
                                    <li><a href="reservation.php">Reservation Management</a></li>
                                    <li class="active">Reservation ID-<?php echo $reservationData['res_id']; ?></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                   ...
                                   <div class="row form-group">
                                       <div class="col col-md-3"><label for="text-input" class=" form-control-label">Reservation ID  </label></div>
                                       <div class="col-12 col-md-9">
                                           <input type="text" id="res_id" name="cus-fname" placeholder="Customer First Name" class="form-control" value="<?php echo $reservationData['res_id']; ?>" readonly>
                                   ...
                                   <div class="row form-group">
                                       ...
                                       <div class="col-12 col-md-9">
                                           <input type="text" id="res_id" name="cus-fname" placeholder="Customer First Name" class="form-control" value="<?php echo $reservationData['pkg_name']; ?>" readonly>
                                   ...
                                   <div class="row form-group">
                                       ...
                                       <div class="col-12 col-md-9">
                                           <input type="text" id="cus-lname" name="cus-lname" placeholder="Customer Surame" class="form-control" value="<?php echo $reservationData['cus_lname']." ".$reservationData['cus_fname']; ?>" readonly>
                                   ...
                                   <div class="row form-group">
                                       ...
                                       <div class="col-12 col-md-9">
                                           <input type="text" id="cus-country" name="cus-country" placeholder="Customer Country" class="form-control" value="<?php echo $reservationData['cus_country']; ?>" readonly>
                                   ...
                                   <div class="row form-group">
                                       ...
                                       <div class="col-12 col-md-9">
                                           <input type="email" id="cus-email" name="cus-email" placeholder="Customer Email" class="form-control" value="<?php echo $reservationData['cus_email']; ?>" readonly>
                                   ...
                                   <div class="row form-group">
                                       ...
                                       <div class="col-12 col-md-9">
                                           <input type="text" id="cus-nic" name="cus-nic" placeholder="Customer NIC" class="form-control" value="<?php echo $reservationData['cus_id']; ?>" readonly>
                                           <span class="text text-danger small" id="cus-nic-error"></span>
                                       </div>
                                   </div>
                                   <div class="row form-group">
                                       <div class="col col-md-3"><label for="text-input" class=" form-control-label">Reservation Date </label></div>
                                       <div class="col-12 col-md-9"><input type="date" id="cus-dob" name="cus-dob" placeholder="Customer Date Of Birth" class="form-control" max="<?php echo date('Y-m-d', strtotime('-18 year')) ?>" value="<?php echo $reservationData['res_date']; ?>" readonly></div>
                                   </div>
                                   
                                   <div class="row form-group">
                                       <div class="col col-md-3"><label for="text-input" class=" form-control-label">Arrival Date </label></div>
                                       <div class="col-12 col-md-9"><input type="date" id="cus-dob" name="cus-dob" placeholder="Customer Date Of Birth" class="form-control" max="<?php echo date('Y-m-d', strtotime('-18 year')) ?>" value="<?php echo $reservationData['arrival_date']; ?>" readonly></div>
                                   </div>
                                   <div class="row form-group">
                                       <div class="col col-md-3"><label for="text-input" class=" form-control-label">Leaving Date </label></div>
                                       <div class="col-12 col-md-9"><input type="date" id="cus-dob" name="cus-dob" placeholder="Customer Date Of Birth" class="form-control" max="<?php echo date('Y-m-d', strtotime('-18 year')) ?>" value="<?php echo $reservationData['leaving_date']; ?>" readonly></div>
                                   </div>
                                   
                                   <div class="row form-group">
                                       <div class="col col-md-3"><label for="text-input" class=" form-control-label">Date Of Birth </label></div>
                                       <div class="col-12 col-md-9"><input type="date" id="cus-dob" name="cus-dob" placeholder="Customer Date Of Birth" class="form-control" max="<?php echo date('Y-m-d', strtotime('-18 year')) ?>" value="<?php echo $reservationData['cus_dob']; ?>" readonly></div>
                                   </div>
                                   <div class="row form-group">
                                       <div class="col col-md-3"><label for="text-input" class=" form-control-label">Contact number </label></div>
                                       <div class="col-12 col-md-9">
                                           <input type="text" id="cus-tel" name="cus-tel" placeholder="Customer Phone number" class="form-control" value="<?php echo $reservationData['cus_tel']; ?>" readonly>
                                           <span class="text text-danger small" id="cus-tel-error"></span>
                                       </div>
                                   </div>
                                   <div class="row form-group">
                                       <div class="col col-md-3"><label for="text-input" class=" form-control-label">Adults number </label></div>
                                       <div class="col-12 col-md-9">
                                           <input type="text" id="cus-tel" name="cus-tel" placeholder="Customer Phone number" class="form-control" value="<?php echo $reservationData['no_of_adults']; ?>" readonly>
                                           <span class="text text-danger small" id="cus-tel-error"></span>
                                       </div>
                                   </div>
                                   <div class="row form-group">
                                       <div class="col col-md-3"><label for="text-input" class=" form-control-label">children number </label></div>
                                       <div class="col-12 col-md-9">
                                           <input type="text" id="cus-tel" name="cus-tel" placeholder="Customer Phone number" class="form-control" value="<?php echo $reservationData['no_of_children']; ?>" readonly>
                                           <span class="text text-danger small" id="cus-tel-error"></span>
                                       </div>
