            ...
            <div class = "card">
                <div class="card-body">
                    <div class="row form-group"> 
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" name="food-name[]" id="food-name" onkeyup="getData(this)" placeholder="food Name" value="" class="form-control food-name" required>
                            <div class="dropdown">
