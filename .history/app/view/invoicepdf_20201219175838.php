	...
	<table width="90%" style="border: 1px solid black;" cellpadding="5" cellspacing="0" align ="center">
		...
		<tbody>
			...
			<tr>
                ...
                <td style="padding: 25px 5px; border-right: 1px solid black; font-size: 20px;"><?php echo $PaymentData['pkg_name'] . "(" . $PaymentData['arrival_date'] . " - " . $PaymentData['leaving_date'] . ")" ?>
                </td>
				<td style="padding: 5px; text-align: right; font-size: 22px;">$<?php echo  $PaymentData['payment_amount']; ?></td>
            </tr>
