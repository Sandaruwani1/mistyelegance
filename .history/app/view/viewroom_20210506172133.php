                            ...
                            <div class="card-body card-block">
                                ...
                                <form action="viewroom.php" method="post" enctype="multipart/form-data" class="form-horizontal" id="editRoomForm">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Room Number </label></div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="select" class=" form-control-label">Package </label></div>
                                        <div class="col-12 col-md-9">
