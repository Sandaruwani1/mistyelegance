...
<body style="margin: 0;">
	...
	<table width="100%">
		<tr>
			...
			<td style="width: 80%; text-align: center;">
				<h1 class="h1" >Artlee Design Studio </h1>
				<p> Artlee Design Studio,
				  N0.23,
				  Sri Palee Terrace,
				  Ballapitiya,
				  Horana.<br/>
	...
	<h2 style="text-align: center;">Invoice[Original]</h2>
	...
	<table width="100%">
		<tr>
			...
			<td style="width: 20%: padding: 10px;">
				<p style="font-weight: bold;">Invoice No: INV00001</p>
				<p style="font-weight: bold;">Date: 2020-10-23</p>
			</td>
		</tr>
	</table>
