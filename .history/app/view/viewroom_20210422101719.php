...
if (!isset($_GET['room_id']) && $_SERVER['REQUEST_METHOD'] != 'POST') {
    header("Location: room.php");
} else {
    
    $roomData = $RoomController->getRoom($_GET['room_id']);
}
...
$roomdata = $RoomController->getPackageName();
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-left">
                                    ...
                                    <li class="active"><?php echo $roomData['room_no']; ?></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <form action="viewroom.php" method="post" enctype="multipart/form-data" class="form-horizontal" id="editRoomForm">

                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Room Number<span style="color: red;">*</span> </label></div>
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="room-no" name="room-no" class="form-control" value="<?php echo $roomData['room_no']; ?>" readonly>
                                            <span class="text text-danger small" id="cus-fname-error"></span>
                                        </div>
                                    </div>
                                    
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="select" class=" form-control-label">Package<span style="color: red;">*</span> </label></div>
                                        <div class="col-12 col-md-9">
                                            <select name="pkg-id" id="pkg-id" class="form-control" required>
                                                <option value="">Please Select a Package</option>
                                                <?php  
                                                foreach ($roomdata as $packageName){
                                            ?>
                                                 <option value="<?php echo $packageName['pkg_id']; ?>" <?php echo ($packageName['pkg_id'] == $roomData['pkg_id']) ? 'selected' : '' ?>><?php echo $packageName['pkg_name']; ?></option>
                                            <?php
                                                }
                                            ?>
                                            </select>
                                            <span class="text text-danger small" id="pkg-id-error"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input type="hidden" name="room-id" value="<?php echo $roomData['room_id']; ?>" />
                                    </div>
                                </form>
