                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="button" id="username-edit-btn"
                                        ...
                                        <div class="form-group" id="username-submit-btn-div">
                                            <button class="btn btn-sm btn-outline-success"
                                                id="username-submit-btn">Submit</button>
                                            <button class="btn btn-sm btn-outline-danger" id="username-cancel-btn"><i
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group" id="password-submit-btn-div">
                                            ...
                                            <button class="btn btn-sm btn-outline-danger" id="password-cancel-btn"><i
                                                    class="fa fa-times"></i> Cancel</button>
                                        </div>
                                    </div>
