<?php
    ...
    $Fooddata = $FoodController->getFoodcatName();
    
     
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        $FoodController = new FoodController();
        $FoodController->addFood($_POST);
    } 
...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <button class="btn btn-primary"data-toggle="modal" data-target="#addroom"><i class="fa fa-plus"></i> Add New Foods</button>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <table id="food-detail" class="table table-hover">
                                    <thead>
                                        <tr>
                                            <th>Food Name</th>
                                            <th>Food Category</th>
    ...
    <!-- Modal -->
    <div class="modal fade" id="addroom" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" id="addFoodForm">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="food-name" name="food-name" placeholder="food Name" value="" class="form-control" required>
                                            <span class="text text-danger small" id="food-name-error"></span>
                                        </div>
                                    </div>
                                    
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="select" class=" form-control-label">Food Type<span style="color: red;">*</span> </label></div>
                                        <div class="col-12 col-md-9">
                                            <select name="food-cat-id" id="food-cat-id" class="form-control" required>
                                                <option value="">Please Select a Food</option>
                                                <?php  
                                                foreach ($Fooddata as $foodcat){
                                            ?>
                                                <option value="<?php echo $foodcat['food_cat_id']?>"><?php echo $foodcat['food_cat_name'] ?></option>
                                            <?php
                                                }
                                            ?>
                                            </select>
                                            <span class="text text-danger small" id="food-cat-id-error"></span>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="food-portion" name="food-portion" placeholder="food Portion" value="" class="form-control" required>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="food-price" name="food-price" placeholder="food Price" value="" class="form-control" required>
    ...
    <script type="text/javascript">
        $(document).ready(function (){
             var roomRecords = $('#food-detail').DataTable({
                "lengthChange": true,
                "processing":true,
                "serverSide":true,
                "order":[],
                  ...
                  "columnDefs":[
                       {
                            ...
                            "render": function(data,type,row){
                                return "<button class='btn btn-sm btn-outline-secondary' onclick='viewFood(" + data +")'><i class='fa fa-folder-open-o'></i> View</button> <button class='btn btn-sm btn-outline-danger' onclick='deleteFood(" + data +")'><i class='fa fa-trash-o'></i> Delete</button> ";
                            },
                            "targets":3
                        }, 
                   ] 
        ...
        function viewFood(foodId){
            window.location.href = "viewfood.php?food_id=" + foodId;
        }
                ...
                $.post('../ajax/foodajax.php',{
                    ...
                    if(response){
                       Swal.fire(
                        ...
                        $("#food-detail").DataTable().clear().draw();
                   }else{
                        Swal.fire({
                            icon: 'error',
                            title: 'Oops...',
