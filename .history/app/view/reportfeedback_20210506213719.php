<?php
    ...
    $packagedata = $RoomController->getPackageName();
...
<body>
                ...
                <div class="col-sm-6">
                    <div class="card w-100">
                        <div class="card-body">
                            ...
                            <label style="font-weight:bold; text-align:left"> Package: </label>
    ...
    function createFeedbackAnalysisReport() {
       ...
       // var untilDate = $("#report-until-feedback-analysis").val();
        ...
        //     return false;
        // }
        window.open(`reportpdf.php?type=feedback_analysis&package=${package}`, '_blank');
    }
