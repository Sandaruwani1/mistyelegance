        ...
        var userRecords = $('#user-detail').DataTable({
            ...
            "columnDefs": [{
                ...
                },
                {
                    "data": "4",
                    "render": function(data, type, row) {
                        return "<button class='btn btn-sm btn-outline-secondary' onclick='viewUser(" +data +")'><i class='fa fa-folder-open-o'></i> View</button>  <button class='btn btn-sm btn-outline-danger' onclick='deleteUser(" +
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        return (row['4'] != <?php echo $loggedUser['user_id'] ?> ) ? (data ==
                            ...
                            row['4'] + ")'> Enable</button>" : ''
                            (row['4']!=<?php echo $loggedUser['user_id']?>)?
