...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            <button class="btn btn-primary"data-toggle="modal" data-target="#adduser"><i class="fa fa-plus"></i> Add User</button>
         ...
         <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal" id="adduser">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" autocomplete="off" id="emp-name" name="emp-name" placeholder="Enter Employee Name" class="form-control">
                  ...
                  "columnDefs":[
                        {
                            ...
                            "render": function(data,type,row){
                                return (data== '')?"<img class='rounded-circle' width='80px' src='../resources/images/users/default.png' />" : "<img class='rounded-circle' width='80px' src='../resources/images/users/" + data + "' />";
                            },
                            "targets":0
                        },
                        {
                            "data":"4",
                            "render": function(data,type,row){
                                return "<button class='btn btn-sm btn-outline-secondary' onclick='viewUser(" + data +")'><i class='fa fa-folder-open-o'></i> View</button>                                 <button class='btn btn-sm btn-outline-danger' onclick='deleteUser(" + data +")'><i class='fa fa-trash-o'></i> Delete</button>";
                            },
                            "targets":4, "width": "20%"
                        },
                        {
                            "data":"5",
                            "render":function(data,type,row){
                                return (row['4'] != <?php echo $loggedUser['user_id'] ?>) ? (data == 1)?"<button class='btn btn-danger btn-sm' id='Disable-btn' onclick='changestatus("+ row['4'] +")'>Disable</button>":"<button class='btn btn-success btn-sm' id='Enable-btn' onclick='changestatus("+row['4'] +")'> Enable</button>" : ''
                            },
                            "targets":5,"width":"10%"
                        },
                   ]
     ...
     $("#adduser").submit(function (event){
            ...
            if(password != confirmpassword){
             ...
             $.post('../ajax/userajax.php',{
                ...
                if(response == 1){
                    $("#user-name-error").text("User name  exist in the system. Please enter different User name");
                    $("#user-name").focus();
                    return false;
                }
                else if(response == -1){
