...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <button class="btn btn-primary"data-toggle="modal" data-target="#addFoodresForm"><i class="fa fa-plus"></i> Add Food Reservation</button>
    ...
    <!-- Modal -->
    <div class="modal fade" id="addFoodresForm" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" id="addFoodresForm">
                                   
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row form-group"> 
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Resevation Id<span style="color: red;">*</span> </label></div>
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="res-id" name="res-id" placeholder="Reservation Id" value="" class="form-control" required>
                                ...
                                <button class="btn btn-success btn-sm mb-3" type="button" id="addrow" ><i class="fa fa-plus"></i>Add Food</button>


                                <div class="row">
                                    <div class="col-md-6"><h5><strong>Amount:</h5></strong></div>
        ...
        $(document).ready(function (){
             var foodresRecords = $('#restuarant-detail').DataTable({
                ...
                "ajax":{
                    ...
                    type:"POST",
                    data:{action:'getAllFoodreservations'}
                },
                 "columns":[
                    {"data":"0"},
                    {"data":"1"},
                  ...
                  "columnDefs":[
                       {
                            ...
                            "render": function(data,type,row){
                                return "<button class='btn btn-sm btn-outline-danger' onclick='cancelFoodres(" + data +")'><i class='fa fa-times'></i> Cancel</button> ";
                            },
                            "targets":4
                        }, 
                   ] 
            ...
            <div class = "card">
                <div class="card-body">
                    <div class="row form-group"> 
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" name="food-name[]" onkeyup="getData(this)" placeholder="food Name" value="" class="form-control food-name" required>
                            <div class="dropdown">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="number" id="food-portion" name="food-portion" placeholder="food Portion" value="" class="form-control" required>
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" name="food-price[]" onkeyup="setTotalAmount()" placeholder="food Price" class="form-control food-price" required>
