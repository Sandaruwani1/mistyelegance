...
<body>
            ...
            <div class = "card">
                <div class="card-body">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="number" id="food-portion" name="food-portion" onchange="getportionData(this)" placeholder="food Portion" value="" class="form-control" required>
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" name="food-price[]" class="foodprice" onkeyup="setTotalAmount()" placeholder="food Price" class="form-control food-price" readonly>
    ...
    $('#food-portion').on('change', 'input', function() {
  // Does some stuff and logs the event to the console
        ...
        var foodName=$('#food-name').val();
            ...
            $.ajax({
                    ...
                    success: function(data) {
                        if (data) {
                            $(e).siblings(".foodprice").css('display', 'block');
                            $(e).siblings(".foodprice").html(data);
                        } 
