                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="container-fluid">
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-sm-12">
                                                    <a href="reservationcustomerform.php?<?php echo 'arr=' . $_GET['arr'] . '&lev=' . $_GET['lev'] . '&adults=' . $_GET['adults'] . '&children=' . $_GET['children'] . '&pkg_id=' . $availablePkg['pkg_id']; ?>" style="width: 100%;" class="btn btn-primary">Reserve</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
