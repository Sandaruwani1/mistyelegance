...
if (!isset($_GET['food_id']) && $_SERVER['REQUEST_METHOD'] != 'POST') {
    header("Location: food.php");
} else {
    
    $foodData = $FoodController->getFood($_GET['food_id']);
}
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    $FoodController = new FoodController();
    $FoodController->updateFood($_POST);
}
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-left">
                                    <li><a href="food.php">Food Management</a></li>
                                    <li class="active"><?php echo $foodData['food_name']; ?></li>
                                </ol>
                            </div>
                        </div>
                    </div>
        ...
        <div class="content">
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" id="addFoodForm">
                                   ...
                                   <div class="row form-group">
                                       ...
                                       <div class="col-12 col-md-9">
                                           <input type="text" id="food-name" name="food-name" placeholder="food Name" value="<?php echo $foodData['food_name']; ?>" class="form-control" required>
                                   ...
                                   <div class="row form-group">
                                       ...
                                       <div class="col-12 col-md-9">
                                           ...
                                           ?>
                                               <option value="<?php echo $foodcat['food_cat_id']; ?>" <?php echo ($foodcat['food_cat_id'] == $foodData['food_cat_id']) ? 'selected' : '' ?>><?php echo $foodcat['food_cat_name']; ?></option>
                                           <?php
                                               }
                                           ?>
                                           </select>
                                   ...
                                   <div class="row form-group">
                                       ...
                                       <div class="col-12 col-md-9">
                                           <input type="text" id="food-price" name="food-price" placeholder="food Price" value="<?php echo $foodData['food_price']; ?>" class="form-control" required>
         ...
         <div class="modal-footer">
           ...
           <input type="hidden" name="food-id" value="<?php echo $foodData['food_id']; ?>" />
         </div>
       </form>
