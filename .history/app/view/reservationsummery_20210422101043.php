...
$CusData = $reservationController->getCustomerById($_GET['cus_id']);
            ...
            $.post('../ajax/reservationajax.php', {
                ...
                if (data > 0) {
                    $("#res-btns").html(`<button type="button" class="btn btn-success" disabled><i class="fa fa-check" aria-hidden="true"></i> Confirmed</button>
                                            <button type=\"button\" class=\"btn btn-primary\" onclick=\"window.open('invoicepdf.php?payment_id=${data}&type=advance', '_blank')\">
