...
<body>
    ...
    $("#addrow").click(function() {
        var output = `
            <div class = "card">
                <div class="card-body">
                    <div class="row form-group food-info-row"> 
                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Food Name<span style="color: red;">*</span> </label></div>
                        <div class="col-12 col-md-9 food-info-col">
                            <input type="text" name="food-name[]" id="food-name" onkeyup="getData(this)" placeholder="food Name" value="" class="form-control food-name" autocomplete="off" required>
                    ...
                    <div class="row form-group food-price-row">
                        ...
                        <div class="col-12 col-md-9 food-price-col">
                            <input type="text" name="food-price[]" placeholder="food Price" class="form-control food-price" readonly>
    ...
    function cancelFoodres(food_res_Id) {
        ...
        Swal.fire({
            ...
            confirmButtonText: 'Yes, Cancel Food Reservation it!'
        }).then((result) => {
            if (result.value) {
    ...
    function getPortionData(e){
        ...
        var portion = $(e).val();
        var foodId = $(e).parent().parent().siblings(".food-info-row").children('.food-info-col').children('.food-id').val();

        if(foodId == ""){
            $(e).val("");
            $(e).parent().parent().siblings(".food-info-row").children('.food-info-col').children('.food-name').focus();
           // alert("Please Enter a food Name");
            Swal.fire({
                            icon: 'error',
                            title: 'Oops...',
                            text: 'Please enter the food name!'
                        });
