...
<body style="margin: 0;">
	...
	<table width="100%">
		<tr>
			<td style="width: 80%; padding: 10px 50px;">
				<span>
					Geust Name:<?php echo $PaymentData['cus_fname']." ".$PaymentData['cus_lname'];?><br/>
					No 3<br/>Main road<br />Panadura.<br/>
					Contact No: <?php echo $PaymentData['cus_tel'];?>0711111111
				</span>
			</td>
	...
	<table width="90%" style="border: 1px solid black;" cellpadding="5" cellspacing="0" align ="center">
        ...
        <tr>
			...
			<tr>
				...
				<td style="padding: 5px; text-align: right;"> <?php echo "$. $PaymentData['payment_amount']";?>50000.00</td>
            </tr>
	...
	<h3 style="text-align: right; padding-right: 50px;">Total: <?php echo "$. $PaymentData['res_amount']";?>.00</h3>
