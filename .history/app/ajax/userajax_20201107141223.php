...
if($_POST['action'] == 'getusers'){
	...
	$table = <<<EOT
 (
	SELECT emp.emp_image,emp.emp_fname,emp.emp_lname,d.desig_Title,u.user_id,u.user_status FROM employee emp,user u,designation d WHERE emp.emp_id=u.emp_id,d.desig_id=emp.desig_id AND u.is_deleted=0
 ) temp
EOT;
