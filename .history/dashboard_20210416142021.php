            ...
            <div class="tm-container-outer" id="tm-section-3">
                ...
                <section class="tm-slideshow-section">
                    ...
                    if (file_exists("/resources/images/customers/" . $customerInfo['cus_id'])) {
                        ?>
                        <img src="/resources/images/customers/<?php echo $customerInfo['cus_id']; ?>" alt="Image" style="border-radius: 70%">
                    <?php
                    }else{
                        ?>
                         <img src="/resources/images/customers/default.png" alt="Image" style="border-radius: 70%">
                    <?php
                    } 
                    ?>
