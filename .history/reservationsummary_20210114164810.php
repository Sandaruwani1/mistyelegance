                ...
                <div class="tm-container-outer tm-banner-bg">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <h6 class="card-title">Customer Name: <?php echo $CusData['cus_fname'] . " " . $CusData['cus_lname']; ?></h6>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <h6 class="card-title">Arrival Date: <?php echo $_GET['arr']; ?></h6>
                            </div>
                            <div class="col-sm-6">
                                <h6 class="card-title">Leaving Date: <?php echo $_GET['lev']; ?></h6>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
