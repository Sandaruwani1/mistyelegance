...
$customerInfo = $_SESSION['customer_info'];
  ...
  // $AllpkgData=$packagesController->getAllPackages();
    ...
    $maxAdultsAndChildrenCountsOfPkg = $getMaxAdultsAndChildrenCountsOfPkg->getPkg($_GET['pkg_id']);;
            ...
            <section class="tm-banner">
                <div class="tm-container-outer tm-banner-bg">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <h6 class="card-title">Adults: </h6><input type="number" class="form control" placeholder="Adults" value="<?php echo $_GET['adults']; ?>" min="1" />
                            </div>
                            <div class="col-sm-6">
                                <h6 class="card-title">Children: </h6><input type="number" class="form control" placeholder="Adults" value="<?php echo $_GET['children']; ?>" min="0" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
