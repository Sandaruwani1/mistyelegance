                            ...
                            ?>
                                ...
                                <div class="tm-recommended-description-box">
                                    ...
                                    <p class="tm-text-highlight">Adults: <?php
                                                            ...
                                                            ?>|Room size: <?php echo $AllpkgData['size_of_rooms'];?> m
                                        <sup>2</sup></p>
                                    <p class="tm-text-gray"> <?php echo $AllpkgData['pkg_des'];?> </p>
                                    <button type="button" onclick="loadPkgData(<?php echo $AllpkgData['pkg_id'];?>)"
                                        class="btn btn-primary" data-toggle="modal" data-target="#pkgModal">
                                        View
                                    </button>
                                </div>
                                <a href="javascript:void(0)" onclick="bookNow(<?php echo $AllpkgData['pkg_id'];?>)"
                                    ...
                                    if (($AllpkgData['discount_from'] <= date('Y-m-d') && $AllpkgData['discount_until'] >= date('Y-m-d'))) {
                                            ...
                                            echo  " <del style=''>  $$rate </del>"  . "    " . "$" .  $AllpkgData['discount'];
                                ...
                                <div class="Stars" style="--rating: <?php echo $resData['rating']; ?>;"
                                    aria-label="Rating of this product is <?php echo $resData['rating']; ?> out of 5.">
                                </div>
