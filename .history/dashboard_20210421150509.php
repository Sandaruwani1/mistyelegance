            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="file-input" class=" form-control-label">Add A New User Image
                            </label></div>
                        <div class="col-12 col-md-9"><input type="file" id="emp-image" name="file-input"
