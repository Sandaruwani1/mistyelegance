<?php
  ...
  session_start();
$urlData = '';
if(isset($_GET['arr_date']) && isset($_GET['lev_date']) && isset($_GET['pkg_id'])){
    $urlData .= "?arr_date=" . $_GET['arr_date'] . '&lev_date=' . $_GET['lev_date'] . '&adults=' . $_GET['adults'] . '&children=' . $_GET['children'] . '&pkg_id=' . $_GET['pkg_id'];
...
if(isset($_POST['submit'])){
    ...
    $customerController->Login($_POST['user-name'], sha1($_POST['password']), $_GET);

}
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    $customerController = new customerController();
    $customerController->addCustomer($_POST, $_GET);
}
...
-->
 ...
 <!-- row -->
                        ...
                        <form action="login.php<?php echo $urlData ?>" method="post" enctype="multipart/form-data" class="form-horizontal tm-search-form tm-section-pad-2" id="adduser">
                        ...
                        <form action="login.php<?php echo $urlData ?>" method="post" enctype="multipart/form-data" class="form-horizontal tm-search-form tm-section-pad-2" id="addCustomerForm">
