                            ...
                            <form action="" method="get" class="tm-search-form tm-section-pad-2">
                                <div class="form-row tm-search-form-row">                                
                                    <div class="form-group tm-form-group tm-form-group-pad tm-form-group-3">
                                        ...
                                        <input name="check-in" id="check-in" type="date" class="form-control" placeholder="Check In" value="<?php echo (isset($_GET['check-in']))?$_GET['check-in']: '';  ?>" required>
                                    </div>
                                    <div class="form-group tm-form-group tm-form-group-pad tm-form-group-3">
                                        <label for="inputCheckOut">Check Out Date</label>
                                        <input name="check-out" id="check-out" type="date" class="form-control" placeholder="Check Out" value="<?php echo (isset($_GET['check-out']))?$_GET['check-out']: '';  ?>" required>
                                    </div>
                                    <div class="form-group tm-form-group tm-form-group-1">
                                        <div class="form-group tm-form-group tm-form-group-pad tm-form-group-3">                                       
                                            <label for="inputAdult">Adult</label>     
                                            <select name="adult" class="form-control tm-select" id="inputAdult" value="<?php echo (isset($_GET['adults']))?$_GET['adults']: 1;  ?>">
                                        ...
                                        <div class="form-group tm-form-group tm-form-group-pad tm-form-group-3">
                                            ...
                                            <select name="children" class="form-control tm-select" id="inputChildren" value="<?php echo (isset($_GET['children']))?$_GET['children']: 0;  ?>">
                    ...
                    <!-- Current Active Tab WITH "show active" classes in DIV tag -->
                        ...
                        <?php
                            ...
                            <img src="<?php echo $imagePath; ?>" alt="Image" class="img-fluid tm-recommended-img">
                                ...
                                onclick="bookNow(<?php echo $AllpkgData['pkg_id'];?>)" 
                                ...
                                <div class="Stars" style="--rating: <?php echo $resData['rating']; ?>;" aria-label="Rating of this product is <?php echo $resData['rating']; ?> out of 5."></div>                 
                            </div>
                            <?php
                            }
                        } 
