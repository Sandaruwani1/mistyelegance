                ...
                <section class="tm-slideshow-section">
                    ...
                    <div class="form-group">
                        <div id="firstname11-div">
                         ...
                         <br/>
                        <span><h4 style="float: left;"><?php echo  $cusData['cus_fname']; ?></h4>
                        <button type="button" class="btn btn-primary btn-sm tm-btn tm-btn-search-sm text-uppercase" id="editfnamebtn" style="font-size:xx-small;" >edit</button>
                        </span>
                        </div>
                       
                    </div>
                    <div class="form-group d-none" id="firstname-div">
                            <input type="text" id="first_name" value="<?php echo $cusData['cus_fname']; ?>" placeholder="Enter Username" class="form-control">
                            ...
                            <button class="btn btn-sm btn-outline-danger" id="fname-cancel-btn"><i class="fa fa-times" ></i> Cancel</button>
                            </div>
                    </div>
                    ...
                    <div class="form-group">
                         ...
                         <br/>
                        <span><h4 style="float: left;"><?php echo  $cusData['cus_lname']; ?></h4>
                        <button type="submit" class="btn btn-primary btn-sm tm-btn tm-btn-search-sm text-uppercase" id="editlnamebtn" style="font-size :xx-small;" >edit</button>
                        </span>
                    </div>
                    <div class="form-group d-none" id="lastname-div">
                            <input type="text" id="last_name" value="<?php echo $cusData['cus_lname']; ?>" placeholder="Enter Username" class="form-control">
                            <span id="user_name_error" class="text text-danger"></span>
                            <div class="form-group" id="username-submit-btn-div">
                            <button class="btn btn-sm btn-outline-success" id="lname-submit-btn">Submit</button>
                            <button class="btn btn-sm btn-outline-danger" id="lname-cancel-btn"><i class="fa fa-times" ></i> Cancel</button>
                            </div>
                    </div>
                    ...
                    <div class="form-group">
                         ...
                         <br/>
                        <span><h4 style="float: left;"><?php echo  $cusData['cus_email']; ?></h4>
                        <button type="submit" class="btn btn-primary btn-sm tm-btn tm-btn-search-sm text-uppercase" id="editemailbtn" style="font-size :xx-small;" >edit</button>
                        </span>
                    </div>
                    <div class="form-group d-none" id="email-div">
                            <input type="text" id="email" value="<?php echo $cusData['cus_email']; ?>" placeholder="Enter Username" class="form-control">
                            <span id="user_name_error" class="text text-danger"></span>
                            <div class="form-group" id="username-submit-btn-div">
                            <button class="btn btn-sm btn-outline-success" id="email-submit-btn">Submit</button>
                            <button class="btn btn-sm btn-outline-danger" id="email-cancel-btn"><i class="fa fa-times" ></i> Cancel</button>
                            </div>
                    </div>
                    ...
                    <div class="form-group">
                         ...
                         <br/>
                        <span><h4 style="float: left;"><?php echo  $cusData['cus_tel'] ; ?></h4>
                        <button type="submit" class="btn btn-primary btn-sm tm-btn tm-btn-search-sm text-uppercase" id="editcontactbtn" style="font-size :xx-small;" >edit</button>
                        </span>
                    </div>
                    <div class="form-group d-none" id="contact-div">
                            <input type="text" id="contact_no" value="<?php echo $cusData['cus_tel']; ?>" placeholder="Enter Username" class="form-control">
                            <span id="user_name_error" class="text text-danger"></span>
                            <div class="form-group" id="username-submit-btn-div">
                            <button class="btn btn-sm btn-outline-success" id="contact-submit-btn">Submit</button>
                            <button class="btn btn-sm btn-outline-danger" id="contact-cancel-btn"><i class="fa fa-times" ></i> Cancel</button>
                            </div>
                    </div>
                    ...
                    <div class="form-group">
                         ...
                         <br/>
                        <span><h4><?php echo  $cusData['cus_id']; ?></h4></span>
                    </div>
                    <div class="form-group">
                         <label for="name" class=" form-control-label">Country </label>
                         <br/>
                        <span><h4><?php echo  $cusData['cus_country']; ?></h4></span>
                    </div>
                    <div class="form-group">
                         <label for="name" class=" form-control-label">Gender</label>
                         <br/>
                        <span><h4><?php echo  $cusData['cus_gender']; ?></h4></span>
                    </div>
                    </div>
                </section>
