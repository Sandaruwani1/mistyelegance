                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><button type="button"
                                            ...
                                            data-toggle="modal" data-target="#exampleModalCenter" onclick="fillDataToModal(<?php echo $data['pkg_id']; ?>, '<?php echo $data['pkg_name']; ?>')">Add Rating & FeedBack</button>
                                    </td>
                                    <?php
                                        }else { ?>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <textarea name="feedback" id="feedback" rows="8" placeholder="Feedback" style="width: 100%"></textarea>
                        </div>
                    </div>
                    </div>
                </div>
