...
<body>
                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><button type="button"
                                            ...
                                            data-toggle="modal" data-target="#exampleModalCenter">Add FeedBack</button>
                                    </td>
                                    <td><button type="button"
                                            class="btn btn-primary tm-btn-primary tm-btn-send text-uppercase"
                                            data-toggle="modal" data-target="#exampleModalCenter">Add FeedBack</button>
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="z-index: 1000000000; margin-top: auto;">
