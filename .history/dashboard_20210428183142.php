            ...
            <div class="tab-content clearfix">
                ...
                <div class="tm-container-outer" id="tm-section-2">
                    ...
                    if (file_exists("./resources/images/customers/" . $customerInfo['cus_id'])) {
                        ...
                        ?>
                            <img src="./resources/images/customers/<?php echo ($cusData['cus_image'] != "")? $cusData['cus_image']: "default.png" ; ?>" alt="Image" width="80%" height="80%"
                            ...
                            <table class="table table-striped">
                                ...
                                <tr id="<?php echo $data['res_id']; ?>">
                                    ...
                                    <td><button type="button"
                                            ...
                                            onclick="fillDataToModal(<?php echo $data['pkg_id']; ?>, '<?php echo $data['pkg_name']; ?>', <?php echo $data['res_id']; ?>)">Add
                                    ...
                                    <div class="stars-outer">
                                        <div class="stars-inner" style="width: <?php echo (((int)$data['rating']) * 20); ?>%;"></div>
                                    </div>
                                        <br />
    ...
    $("#add-rating").click(function() {
        ...
        $.post('./dashboardajax.php', {
            ...
            if (response) {
                ...
                var output = `
                                     <div class="stars-outer">
                                        <div class="stars-inner" style="width:  ${((parseInt(data['rating'])) * 20)} %;"></div>
                                    </div>
                                    <br />
                                    ${data['feedback']}
                        `;
