...
$userData = $customerController->getCustomer($customerInfo['cus_id']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="tm-container-outer" id="tm-section-3">
                ...
                <section class="tm-slideshow-section">
                    ...
                    <div class="form-group d-none" id="lastname-div">
                            <input type="text" id="last_name" value="<?php echo $customerInfo['cus_lname']; ?>" placeholder="Enter Username" class="form-control">
                            <span id="user_name_error" class="text text-danger"></span>
                            <div class="form-group" id="username-submit-btn-div">
                    ...
                    <div class="form-group d-none" id="email-div">
                            <input type="text" id="email" value="<?php echo $customerInfo['cus_email']; ?>" placeholder="Enter Username" class="form-control">
                            <span id="user_name_error" class="text text-danger"></span>
                            <div class="form-group" id="username-submit-btn-div">
                    ...
                    <div class="form-group d-none" id="contact-div">
                            <input type="text" id="contact_no" value="<?php echo $customerInfo['cus_tel']; ?>" placeholder="Enter Username" class="form-control">
                            <span id="user_name_error" class="text text-danger"></span>
                            <div class="form-group" id="username-submit-btn-div">
