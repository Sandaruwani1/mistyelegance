...
-->
    ...
    <script>
      ...
      $(document).ready(function(){
            $("#firstname-div").hide();
            $("#firstname-submit-btn-div").hide();
            $("#password-div").hide();
            $("#confirmpassword-div").hide();
            $("#password-submit-btn-div").hide();
        });

        $("#firstname-edit-btn").click(function(){
            $("#firstname-div").show();
            $("#firstname-submit-btn-div").show();
            $("#firstname-edit-btn").hide();
            $("#firstname-span").hide();
        });

        $("#firstname-cancel-btn").click(function(){
            $("#firstname-div").hide();
            $("#firstname-submit-btn-div").hide();
            $("#firstname-edit-btn").show();
            $("#firstname-span").show();
            $("#user_name").val($.trim($("#firstname-span").text()));
