            ...
            <div class="tm-container-outer" id="tm-section-3">
                ...
                <section class="tm-slideshow-section">
                    ...
                    <div class="form-group">
                         ...
                         <br/>
                        <span><h4><?php echo  $customerInfo['cus_fname']; ?></h4>
                    ...
                    <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm tm-btn tm-btn-search-sm text-uppercase" id="btnSubmit" style="font-size :x-small';" >edit</button>
                        </span>
                    </div>
                    <div class="form-group">
