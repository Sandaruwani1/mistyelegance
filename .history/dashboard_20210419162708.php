                                ...
                                <tr>
                                    ...
                                    <?php
                                        ...
                                        if ($data['rating']== "" || $data['feedback']) {
                                            ?>
                                    <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter"></td>
                                    <td><button type="button" class="btn btn-primary tm-btn-primary tm-btn-send text-uppercase" data-toggle="modal" data-target="#exampleModalCenter">Add FeedBack</button></td>
                                    <?php
                                        }else { ?>
