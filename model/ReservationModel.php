...
class ReservationModel{
	...
	function getReservationsBetweenDates($con,$from,$until){
		...
		$stmt = $con->prepare("SELECT res.res_id, cus.cus_id, cus.cus_fname, cus.cus_lname, cus.cus_country, pkg.pkg_name, res.arrival_date, res.leaving_date from reservation res, packages pkg, customer cus, room r WHERE res.cus_id=cus.cus_id AND r.room_id=res.room_id AND r.pkg_id=pkg.pkg_id AND res.res_date BETWEEN ? AND ?");
